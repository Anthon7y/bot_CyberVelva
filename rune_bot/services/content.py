...
from config import (
    ...
    STEAMPUNK_DIR, STEAMPUNK_MAIN_DIR, ADVICES_FILE,
    RUNES_VALUES_ROOT, DATA_DIR
)
...
# Маппинг номеров файлов на имена рун (только 24 руны старого футарка)
RUNE_NAMES_MAP = {
    "1": "Феху",
    "2": "Уруз", 
    "3": "Турисаз",
...
def get_steampunk_main_cards() -> list[dict]:
    """Возвращает список карт из папки STEAMPUNK_MAIN."""
    cards = []
    try:
...
def get_practicum_image_path() -> str:
    """Возвращает путь к изображению PRAC.jpg."""
    return os.path.join(DATA_DIR, "images", "PRAC.jpg")
